...
/* each of the nextImage functions have cycling images and there's 3 for each individual box inside the  color box in my html. the images will just switch from one to the other.*/ 
